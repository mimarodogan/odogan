...
final class Post
{
    ...
    /**
     * Smart ilgili yazılar — etiket sistemi kaldırıldıktan sonra (T1):
     *   1) Aynı kategoride yayınlanmış yazılar (yayın tarihine göre desc)
     *   2) Yeterli değilse son yayınlananlardan tamamla
     *
     * Etiket-bazlı paylaşım skoru artık yok; kategori + tazelik yeterli sinyal
     * (ayrıca yazı içinde AutoLinkService glossary + post linklemesi yapıyor).
     *
    ...
    public static function relatedSmart(array $post, int $limit = 4): array
    {
        ...
        // 2) Son yayınlananlar (kategori yetmediyse)
