...
<section class="grid">
    ...
    <?php // G5: Kaydedilen Yazılar — menüden alındı, profil panelinde kart olarak. ?>
    <?php if (function_exists('feature') && feature('save_post_enabled')): ?>
    <article class="card">
        <h2>Kaydedilen Yazılar <span aria-hidden="true">♡</span></h2>
        <p>Daha sonra okumak için ayırdığın yazılar — bu cihazda kaydedilir, üye girişiyle senkron olur.</p>
        <p><a class="btn" href="<?= esc(url('/kaydedilenler')) ?>">Listeyi aç</a></p>
    </article>
    <?php endif; ?>
