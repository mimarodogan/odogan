...
final class PostFormService
{
    ...
    public static function validate(Request $req, int $userId): array
    {
        ...
        $data = [
            ...
            'focus_keyword' => mb_substr(trim((string) $req->input('focus_keyword', '')), 0, 190) ?: null,
            'secondary_keywords' => mb_substr(trim((string) $req->input('secondary_keywords', '')), 0, 500) ?: null,
