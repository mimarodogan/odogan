...
final class Article
{
    ...
    public static function build(array $post, array $author, array $profile, ?array $cover): array
    {
        ...
        // .post .lead kaldırıldı: yazıların çoğunda .lead class'lı element yok
        // ve validator "eşleşme bulunamadı" hatası veriyor. h1 + body ilk
        // paragraf her zaman bulunur, garantili eşleşme.
        $node['speakable'] = [
