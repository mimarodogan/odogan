...
// Hakkımda — kanonik yazar manifestosu (principal_author_slug bazlı)
$router->get('/hakkimda', [AboutController::class, 'show']);

// İletişim — form + handler
$router->get('/iletisim',  [ContactController::class, 'showForm']);
...
// KVKK açık rıza kayıt endpoint'i — cookie-consent.js bunu çağırır.
$router->post('/api/consent', [ConsentController::class, 'record']);
