 ...
 *
 * Cevap formatı (sadece public-safe alanlar):
 *   {
 *     "status": "ok" | "degraded",
 *     "time": "2026-05-14T14:32:11+03:00",
 *     "uptime_ms": 12,
 *     "checks": { "db": "ok", "storage": "ok", "cache": "ok", "mail": "ok" }
 *   }
 *
 * HTTP 200 herhangi bir kritik check fail olmadığında, aksi 503.
 * Cache + mail "soft" kontroller (fail'i degrade saymayız).
 *
 * Güvenlik notu: internal sınıf adları (örn. CacheManager driver class)
 * artık döndürülmez — recon yüzeyini daraltır.
 */
