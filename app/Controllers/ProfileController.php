...
final class ProfileController
{
    ...
    public function activate2fa(Request $req): Response
    {
        ...
        User::update((int) $user['id'], [
            ...
            'totp_recovery_codes' => json_encode(array_values((array) $pending['recovery']), JSON_UNESCAPED_UNICODE),
        ]);
    ...
    public function regenerateRecoveryCodes(Request $req): Response
    {
        ...
        User::update((int) $user['id'], [
            'totp_recovery_codes' => json_encode(array_values($new), JSON_UNESCAPED_UNICODE),
        ]);
