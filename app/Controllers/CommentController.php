...
final class CommentController
{
    public function store(Request $req): Response
    {
        ...
        if ($user === null) {
            ...
            // F2.3 (KVKK): misafir yorumlar için açık rıza checkbox zorunlu.
            // Üye girişliyse kayıt sırasında zaten KVKK kabul edilmiştir.
            $kvkkConsent = $req->input('kvkk_consent', '');
            if ($kvkkConsent !== '1' && $kvkkConsent !== 1 && $kvkkConsent !== true) {
                $errors[] = 'KVKK Aydınlatma Metni onayı zorunludur.';
            }
        }
        ...
        $id = Comment::create([
            ...
            // F2.3 (KVKK): açık rıza zamanı — denetimde ispat için
            'kvkk_consent_at' => date('Y-m-d H:i:s'),
        ]);
